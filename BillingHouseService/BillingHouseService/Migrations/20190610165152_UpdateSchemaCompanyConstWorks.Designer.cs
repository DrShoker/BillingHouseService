...
namespace BH.WebApi.Migrations
{
    ...
    [Migration("20190610165152_UpdateSchemaCompanyConstWorks")]
    partial class UpdateSchemaCompanyConstWorks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BH.DTOL.Entities.SchemeConstructionWorks", b =>
                {
                    b.HasOne("BH.DTOL.Entities.CompanyConstructionWorks", "ConstructionWorks")
                        .WithMany("SchemeConstructionWorks")
                        .HasForeignKey("CompanyConstructionWorksId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BH.DTOL.Entities.ConstructionWorks")
                        .WithMany("SchemeConstructionWorks")
                        .HasForeignKey("ConstructionWorksId");
