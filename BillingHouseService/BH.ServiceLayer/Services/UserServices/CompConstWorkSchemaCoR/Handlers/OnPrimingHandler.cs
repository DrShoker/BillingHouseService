...
{
    public class OnPrimingHandler : AbstractTypeHandler
    {
        ...
        {
            if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Walls_Priming_works)
            {
            ...
            else if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Floor_Priming_works)
            {
            ...
            else if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Ceiling_Priming_works)
            {
