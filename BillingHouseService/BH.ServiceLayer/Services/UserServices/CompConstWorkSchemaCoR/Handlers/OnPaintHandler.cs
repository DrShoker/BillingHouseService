...
{
    public class OnPaintHandler : AbstractTypeHandler
    {
        ...
        {
            if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Walls_Paint_work)
            {
            ...
            else if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Floor_Paint_work)
            {
            ...
            else if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Ceiling_Paint_work)
            {
