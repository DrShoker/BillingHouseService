...
{
    public class OnDismantlingHandler: AbstractTypeHandler
    {
        ...
        {
            if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Walls_dismantling)
            {
            ...
            else if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Floor_dismantling)
            {
            ...
            else if (compConstWork.ConstructionWorks.TypeOfWorks == TypeOfConstructionWorksEnum.Ceiling_dismantling)
            {
